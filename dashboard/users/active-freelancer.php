                    ...
                    <div class="table100">
                        <div class="row">
                            <div class="row justify-content-between w-75 d-flex ">
                                ...
                                <h2 class="allfreelancer"></h2><a href="./" class="btn Btn mx-2">Back</a>
                            </div>
                            <table class="content-table">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="edit ml-2">
                                            <a href='block-user.php?uid=<?php echo $row['UserID']; ?>'><i class="bx bx-block rd-0 rd-tr-10"></i></a>
                                        </td>
                                    </tr>
                                <?php
                                }
