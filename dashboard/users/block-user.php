...
if (!(isset($_SESSION['isLoggedIn']) && $_SESSION['isLoggedIn'] === true)) {
    ...
    <body>
                        ...
                        <div class="row">
                            <div class="col-md-11 ml-5 mt-2">
                                ...
                                if (isset($_GET['uid']) && (!empty($_GET['uid']))) {
                                    ...
                                    $sqlSelectByUID = "SELECT * FROM tbluserpersonaldetails WHERE `UserID`={$uid} AND `AccountStatus`='A'";
                                        ...
                                        if (mysqli_num_rows($querySelectByUID) > 0) {
                                            while ($row = mysqli_fetch_array($querySelectByUID)) { ?>
                                                <div class="row justify-content-between">
                                                    <h1><b>Block : <u><?php echo $row['FirstName'] . " " . $row['LastName']; ?></u></b></h1>
                                                    <form action="#" id="frmBlockUser" autocomplete="off" class="d-flex">
                                                        <input type="hidden" name="uid" id="userid" value="<?php echo $uid; ?>">
                                                        <div class="loadingButton">
                                                        <input type="submit" name="btnBlock" id="btnBlock" value="Block" class="btn Btn1 mx-2">
                                                        </div>
                                                ...
                                                <table class="content-table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['RoleID'] == 3 ? "Customer" : "Freelancer"; ?></td>
                                                    </tr>
                                                </table>
                                                <?php
        ...
        <script src="/FSMS/assets/js/block-user.js"></script>
    </body>
